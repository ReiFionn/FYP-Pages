...
<img src="{{ '/images/IMG_3506.PNG' | relative_url }}" alt="Login/Sign Up Screen Layout" width="300">
<img src="{{ '/images/IMG_3505.PNG' | relative_url }}" alt="Home/Listing Screen Layout" width="300">
